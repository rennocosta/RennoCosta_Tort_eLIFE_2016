...
ccMMstart1 = ccMECconverge[:,0,0,0,2:]
ccMMstart1[ccMMstart1==-1.0] = 1.0
ccMMstart1[isnan(ccMMstart1)] = 0.0
ccMM = np.median(ccMMstart1,axis=0)
ccMM1 = np.percentile(ccMMstart1,75,axis=0)
ccMM2 = np.percentile(ccMMstart1,25,axis=0)
#plot(ccMM1,'k')
#plot(ccMM2,'k')
plot(ccMMstart1.transpose(),color=[0.9,0.9,0.9])
plot(ccMM,'k')
ccMMstart2 = ccMECconverge[:,50,0,0,2:]
ccMMstart2[ccMMstart2==-1.0] = 1.0
ccMMstart2[isnan(ccMMstart2)] = 0.0
ccMM = np.median(ccMMstart2,axis=0)
ccMM1 = np.percentile(ccMMstart2,75,axis=0)
ccMM2 = np.percentile(ccMMstart2,25,axis=0)

#plot(ccMM1,'r')
#plot(ccMM2,'r')
plot(ccMMstart2.transpose(),color=[1.0,0.8,0.8])
plot(ccMM,'r')
plt.ylim((0.65,1.05))   
plt.xlim((-0.1,4.1))   
...
ccMMstart1 = ccHPCconverge[:,0,0,0,2:]
ccMMstart1[ccMMstart1==-1.0] = 1.0
ccMMstart1[isnan(ccMMstart1)] = 0.0
ccMM = np.median(ccMMstart1,axis=0)
ccMM1 = np.percentile(ccMMstart1,75,axis=0)
