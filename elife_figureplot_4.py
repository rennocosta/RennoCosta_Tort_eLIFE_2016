...
plt.savefig('Figures/rennocostatort_elife_fig4A.eps', format='eps', dpi=1000)
...
plt.savefig('Figures/rennocostatort_elife_fig4B.eps', format='eps', dpi=1000)
...
plt.savefig('Figures/rennocostatort_elife_fig4C.eps', format='eps', dpi=1000)
...
plt.savefig('Figures/rennocostatort_elife_fig4Cnotused.eps', format='eps', dpi=1000)
...
plt.savefig('Figures/rennocostatort_elife_fig4Dnotused.eps', format='eps', dpi=1000)
...
plt.savefig('Figures/rennocostatort_elife_fig4D.eps', format='eps', dpi=1000)
