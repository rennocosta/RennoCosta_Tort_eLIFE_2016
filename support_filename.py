...
#cluster
    ...
    def __init__(self,simMode = r"cluster"):
                
        if (simMode == "cluster"):
            self.pathRoot = r"/home/rennocosta/coco2/"
            self.pathData = r"DATAY/" 
        ...
        if (simMode == "UFRGS"):
            self.pathRoot = r"/dados/dzedzar/coco2/"
        ...
        if (simMode == "NPAD"):
            #self.pathRoot = r"/home/crcosta/coco2/"
            self.pathRoot = r"/misc/lustre1/crcosta/coco2/"    
            self.pathData = r"DATA/" 
            self.pathRemapping = r"Remapping/"
            self.pathSimulation = r"Simulation_{0:02d}/"
			#self.pathRun = r"Run_{0:02d}/"
        ...
        if (simMode == "mac"):
            self.pathRoot = r"/Users/dzedzar/Documents/coco/"
            self.pathData = r"DATA3/" 
            self.pathRemapping = r"Remapping/"
            self.pathSimulation = r"Simulation_{0:02d}/"
            #self.pathRun = r"Run_{0:02d}/"
            self.bar = r""
        ...
        if (simMode == r"windows"):
            self.pathRoot = r"C:\Users\rennocosta\Documents\coco\DATAY"
            self.pathData = r"" #r"\DATA" 
            self.pathRemapping = r"\Remapping"
            self.pathSimulation = r"\Simulation_{0:02d}"
            #self.pathRun = r"\Run_{0:02d}"
            self.bar = r"\\" 
        ...
        if (simMode == r"BIOME"):
            self.pathRoot = r"C:\Users\rennocosta\Documents\coco2"
            self.pathData = r"" #r"\DATA" 
            self.pathRemapping = r"\Remapping"
            self.pathSimulation = r"\Simulation_{0:02d}"
            #self.pathRun = r"\Run_{0:02d}"
